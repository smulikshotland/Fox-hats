...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/comps/vertical-toolbar/vertical-toolbar.component.ts"); // import { HttpClientModule }    from '@angular/common/http';
  ...
  function srcAppCompsDetailsDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function DetailsComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DetailsComponent_div_0_Template_button_click_11_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DetailsComponent_div_0_Template_button_click_17_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
    ...
    var DetailsComponent = /*#__PURE__*/function () {
      function DetailsComponent(route, listService, _router, cartService) {
    ...
    DetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["class", "card", "style", "width: 18rem;", 4, "ngIf"], [1, "card", 2, "width", "18rem"], ["alt", "Card image cap", 1, "card-img-top", 3, "src"], [3, "click"], ["routerLink", "/shipping"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterLinkWithHref"]],
  ...
  function srcAppCompsGalleryGalleryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    GalleryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 1,
      consts: [["role", "main"], [2, "margin-top", "80px"], [1, "container"], ["class", "row", 4, "ngIf"], [1, "row"], ["class", "col-md-4", 4, "ngFor", "ngForOf"], [1, "col-md-4"], [1, "card", "mb-4", "shadow-sm"], ["alt", "Photo of a Shiba Inu", 1, "hatImage", 3, "routerLink", "queryParams", "src"], [1, "card-body"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "text-muted"]],
  ...
  function srcAppCompsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(personsList, _router) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function getPerson() {
          ...
          this.personsList.getList().subscribe(function (data) {
            console.log("data", data);
            var y = data.some(function (x) {
              return x.email == email && x.password == password;
            });
            console.log("y", y);

            if (y) {
              _this4._router.navigate(['cart']);
            } else {
    ...
    LoginComponent.ɵfac = function LoginComponent_Factory(t) {
      return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_persons_list_service__WEBPACK_IMPORTED_MODULE_2__["PersonsListService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
    };
  ...
  function srcAppServicesPersonsListServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    PersonsListService.ɵfac = function PersonsListService_Factory(t) {
      return new (t || PersonsListService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };
